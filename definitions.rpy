...
define audio.t1 = "<loop 0>mod_assets/music/bp_FTL_01_TitleScreen.mp3" # Menu Theme - Space Cruise
...
### Custom Music/Audio! ###
define audio.civile = "<loop 0>mod_assets/music/bp_FTL_03_CivilEXPLORE.mp3" # Civil (Explore)
define audio.civilb = "<loop 0>mod_assets/music/bp_FTL_16_CivilBATTLE.mp3" # Civil (Battle)

define audio.laser1 = "mod_assets/sfx/laser1.ogg" # Light Laser 1
define audio.hlaser = "mod_assets/sfx/hlaser.ogg" # Heavy Laser
define audio.hcannon = "mod_assets/sfx/hcannon.ogg" # Heavy Cannon
define audio.hbeam = "mod_assets/sfx/hbeam.ogg" # Heavy Beam
define audio.missile = "mod_assets/sfx/missile.ogg" # Missile

define audio.hull1 = "mod_assets/sfx/hull1.ogg" # Hull Impact 1
define audio.hull2 = "mod_assets/sfx/hull2.ogg" # Hull Impact 2
define audio.hull3 = "mod_assets/sfx/hull3.ogg" # Hull Impact 3
define audio.shield1 = "mod_assets/sfx/shield1.ogg" # Shield Impact 1
define audio.shield2 = "mod_assets/sfx/shield2.ogg" # Shield Impact 2
define audio.shield3 = "mod_assets/sfx/shield3.ogg" # Shield Impact 3
define audio.miss = "mod_assets/sfx/miss.ogg" # Miss
define audio.fire = "<loop 0>mod_assets/sfx/fire.ogg" # Fire
define audio.explosion1 = "mod_assets/sfx/explosion1.ogg" # Explosion 1
define audio.shipexplode = "mod_assets/sfx/shipexplosion.wav" # Ship explosion

define audio.purchase = "mod_assets/sfx/purchase.ogg" # Purchase
define audio.repair = "mod_assets/sfx/repair.ogg" # Repair
define audio.upgrade = "mod_assets/sfx/upgrade.ogg" # Upgrade

define audio.cloak = "mod_assets/sfx/cloak.ogg" # Cloak
define audio.decloak = "mod_assets/sfx/decloak.ogg" # Decloak
define audio.takeoff = "mod_assets/sfx/takeoff.wav" # Takeoff
define audio.ftljump = "mod_assets/sfx/jump.ogg" # Jump
define audio.arrive = "mod_assets/sfx/arrive.ogg" # Arrive
define audio.beep = "mod_assets/sfx/beep.wav" # Beep
define audio.stairs = "mod_assets/sfx/stairs.ogg" # Running up stairs
### End of Custom Music/Audio ###
...
### Custom BGs! ###
image bg roof = "mod_assets/bg/roof.png" # School Roof
image bg sky1 = "mod_assets/bg/sky1.png" # Kestrel taking off
image bg sky2 = "mod_assets/bg/sky2.png" # Kestrel taking off sans Kestrel
image bg sky3 = "mod_assets/bg/sky3.png" # Kestrel taking off 2
image bg shipmain = "mod_assets/bg/shipmain.png" # Ship Main Area
image bg shipcockpit = "mod_assets/bg/shipcockpit.png" # Ship Cockpit

# Space Backgrounds
image bg space1 = "mod_assets/bg/space1.png" # Space 1
image bg space2 = "mod_assets/bg/space2.png" # Space 2
image bg nebula1 = "mod_assets/bg/nebula1.png" # Nebula 1
image bg nebula2 = "mod_assets/bg/nebula2.png" # Nebula 2
image bg planets1 = "mod_assets/bg/planets1.png" # Planets 1
image bg planets2 = "mod_assets/bg/planets1.png" # Planets 2

# Dynamic Background, allows multiple scenes to retain the same background
init python:
    def dynbg():
        renpy.scene()
...
# Ships
image pship 1 = "mod_assets/sprites/[sprite].png" # Player's Ship

image broadsword 1 = "mod_assets/sprites/broadsword.png" # Broadsword frigate
image longsword 1 = "mod_assets/sprites/longsword.png" # Longsword destroyer
image halberd 1 = "mod_assets/sprites/halberd.png" # Halberd cruiser

# Stations
image station1 1 = "mod_assets/sprites/station1.png" # Station 1
...
# Sound Variation
default rshield = ["mod_assets/sfx/shield1.ogg", "mod_assets/sfx/shield2.ogg", "mod_assets/sfx/shield3.ogg"]
default rhull = ["mod_assets/sfx/hull1.ogg", "mod_assets/sfx/hull2.ogg", "mod_assets/sfx/hull3.ogg"]

# Starting music mode
default currentmode = "explore"

# Starting background
default background = "bg space1"