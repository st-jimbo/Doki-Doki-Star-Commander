label ch0_alt:
    ...
    s "Heeeeeeeyyy!!"
    "I see a sentient cinnamon bun running right towards me, oh god it's getting closer--"
    "Oh wait, that's Sayori, my neighbor and good friend since we were children."
    "Maybe I shouldn't let myself get this sleep deprived again."
    "Sayori's the kind of friend you'd never see yourself making today, but it just kind of works out because you've known each other for so long?"
    "If she's going to chase after me like this, I almost feel better off running away."
    ...
    "And thus, today marks the day I sold my soul to a cinnamon bun."
    ...
    show monika 1a
    mc "..."
    "I can't believe Sayori dragged me into this."
    ...
    mc "fucking monikammmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm"
    ...
    "I think of the perfect thing to say in this situation."
    mc "Hey... that's pretty good."
    n 5y "What are you, fucking gay?"
    mc "Heh."
    "Nailed it."
    show natsuki zorder 1 at thide
    hide natsuki
    ...
    show monika 1a
    "Why is she looking straight at me?"
    ...
    "That is, if writing poems is the price I need to pay..."
    mc "...Right."
    ...
    "Well, at least I'll have some friends for once."
    hide sayori
    hide natsuki
    hide yuri
    hide monika
